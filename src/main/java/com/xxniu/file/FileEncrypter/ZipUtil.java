...
public class ZipUtil {
	...
	public static void main(String[] args) {
		...
		try {
			book.zip("E:\\PaymentRecordList.zip", new File("E:\\PaymentRecordList.jsp"));
			book.unZip("E:\\PaymentRecordList.zip", "E:\\PaymentRecordList.jsp");
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public void unZip(String zipFileName, String outputFile) {
		// TODO Auto-generated method stub
